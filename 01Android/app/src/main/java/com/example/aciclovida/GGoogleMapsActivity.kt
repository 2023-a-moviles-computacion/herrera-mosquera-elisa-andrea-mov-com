...
class GGoogleMapsActivity : AppCompatActivity() {
    ...
    fun iniciarLogicaMapa(){
        ...
        fragmentoMapa.getMapAsync{ googlMap ->
            //with(X) => if (X! = null)
            with(googlMap){
                mapa = googlMap
    ...
    fun escucharListeners(){
       ...
       mapa.setOnMarkerClickListener {
        ...
        mapa.setOnCameraMoveStartedListener {
            Log.i("mapa", "setOnCameraStartedListener ${it} ")
        }
                ...
                .addPolyline(
                    PolylineOptions()
                        ...
                        .add(
                            ...
                            LatLng(-0.1763248492901104, -78.486589308046),
            ...
            val poligonoUno = mapa
                .addPolygon(
                    PolygonOptions()
                        .clickable(true)
                        .add(
                            LatLng(-0.171546902239471, -78.48344981495214),
